 ...
 * and modues consumed by plugins, MUST be listed here.
 */
...
export { default as seoParser } from './services/seoParser';
...
export * as OfflineMessagesClasses from './uiClasses/OfflineMessagesClasses';
...
export { default as favs } from './map/favs';
